...
** If you use the original config/plugins generated by Haraka, instead of running the above command, make sure to remove or comment the line 'queue/smtp_forward'. Otherwise, sending the message will always timeout.
